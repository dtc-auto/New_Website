...
from templates.dashboard.Connect_DB \
    import getCarOwner, getColumnChart_p1, getLevel1Attributes, getLevel2Attributes, getPurpose, people_get_pie, people_get_path, CP_get_cluster, Config_get_config, Config_get_config_local
import json
