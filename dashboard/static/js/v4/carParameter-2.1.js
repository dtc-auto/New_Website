...
paramConfig = function(e, t) {
    ...
    this.responseContent = function(e) {
        ...
        i.push("<tbody>"),
        i.push("<tr>"),
        i.push('<th colspan="24" class="cstitle" id="nav_meto_5555555" pid="tab_5555555" show="1"><h3><span>更多信息</span></h3></th>'),
        i.push("</tr>"),
        i.push('<tr id="tr_159">'),
        i.push("<th><div>更多信息</div></th>"),
        i.push('<td colspan="23">'),
        i.push('<div class="more">'),
        i.push('<a target="_blank" href="/' + config.result.seriesEnglish + '/news/guide/">' + config.result.seriesName + "导购</a><br/>"),
        i.push('<a target="_blank" href="/' + config.result.seriesEnglish + '/news/drive/">' + config.result.seriesName + "试驾</a><br/>"),
        i.push('<a target="_blank" href="http://car.chexun.com/price/series-s' + config.result.seriesid + '.html">' + config.result.seriesName + "经销商</a>"),
        i.push("</div>"),
        i.push("</td>"),
        i.push("</tr>"),
        i.push("</tbody>"),
